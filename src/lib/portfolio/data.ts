...
import booklypro from "@/data/portfolio/booklypro.json";

const ALL_PROJECTS = [booklypro, hireworkers, brightSmilesDental, cyberussell] as unknown as PortfolioProject[];
