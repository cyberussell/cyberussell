...
import laundryflow from "@/data/portfolio/laundryflow.json";

const ALL_PROJECTS = [laundryflow, appointmentSystem, hireworkers, brightSmilesDental, cyberussell] as unknown as PortfolioProject[];
