            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              <div className="flex-1">
                ...
                <h3 className="font-sans text-[18px] md:text-[20px] font-bold text-white mb-2">
                  Your bio is ready. Now land the client.
                </h3>
                <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/55 leading-[1.7]">
                  Get 5 proposal templates, invoice and contract templates, and a 30-day action plan to go from bio to first paying client.
                </p>
              </div>
              <a
