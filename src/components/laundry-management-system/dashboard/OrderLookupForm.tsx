    ...
    <form onSubmit={handleSubmit} className="flex items-center gap-2">
      <div className="relative">
        ...
        <input
          ...
          className="w-56 rounded-lg border border-blue-100 bg-white py-2 pl-9 pr-3 text-sm text-[#0B1B33] placeholder:text-slate-400 focus:border-[#38BDF8] focus:outline-none"
        />
      </div>
      <button
        type="submit"
        className="rounded-lg border border-blue-100 bg-white px-3 py-2 text-sm font-semibold text-[#2563EB] transition hover:border-[#38BDF8]/40"
      >
        Go
      </button>
    </form>
