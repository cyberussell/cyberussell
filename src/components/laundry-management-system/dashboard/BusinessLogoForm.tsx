  ...
  return (
    <Card className="p-6">
      ...
      <form action={dispatch} className="flex items-end gap-4">
        <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-xl border border-teal-100 bg-[#F0FDFA]">
          {preview ? (
        ...
        <label className="flex-1">
          ...
          <input
            ...
            className="mt-1 block w-full text-sm text-slate-600 file:mr-3 file:rounded-lg file:border-0 file:bg-[#CCFBF1] file:px-3 file:py-1.5 file:text-sm file:font-medium file:text-[#0D9488]"
          />
