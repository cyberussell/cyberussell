  ...
  return (
    <form action={dispatch} className="flex items-end gap-2">
      ...
      <button
        type="submit"
        disabled={pending}
        className="h-fit rounded-full border border-teal-100 bg-white px-3 py-2 text-sm font-medium text-[#0D9488] transition hover:border-[#22D3EE]/40 disabled:opacity-50"
      >
        {pending ? 'Saving…' : 'Save'}
      </button>
