...
export default function FloatingServiceCard({
  ...
  return (
    <motion.div className="relative z-20 w-full" style={{ x, y }}>
      <motion.div
      ...
      >
        ...
        <Link
          ...
          style={{
            boxShadow: "inset 0 1px 0 rgba(255,255,255,0.10), 0 16px 32px rgba(0,0,0,0.35), 0 0 26px rgba(255,122,26,0.16)",
          }}
        >
