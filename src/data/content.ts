...
export const PAIN_STAT_CARDS = [
  ...
  {
    stat: "13.1%",
    title: "Unemployment — City of Isabela · 2025",
    desc: "The problem is worse outside Metro Manila. In the province, there are fewer jobs — but a bigger opportunity for online income that almost no one is taking advantage of.",
    source: "PSA Annual Provincial Labor Market Statistics, 2025",
  },
] as const;
...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    desc: "The exact process Russell used to leverage AI as an assistant — not a replacement.",
    meta: "PDF · 12 pages · Simple English",
    active: true,
  },
  {
    icon: "TrendingUp",
    iconColor: "#E8373A",
    previewBg: "rgba(232,55,58,0.06)",
    title: "Filipino Seller's 2026 Trend Report",
    desc: "The top 5 products Filipinos are buying online and how to source them locally.",
    meta: "PDF · 20 pages · Research-backed",
    active: true,
  },
  {
    icon: "MapPin",
    iconColor: "rgba(255,255,255,0.25)",
    previewBg: "rgba(255,255,255,0.03)",
    title: "Province to Online: Region II Earning Guide",
    desc: "A specific guide for people in Cagayan Valley who want to tap into the global digital economy.",
