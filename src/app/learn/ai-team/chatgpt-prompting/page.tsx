      ...
      <main className="min-h-screen bg-[#0F0F1A]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-4 mb-8">
            {[
              ...
              <div key={label} className="bg-[#18181F] border border-white/[0.06] rounded-[12px] p-5 flex gap-4">
                ...
                <div>
                  <p className="font-sans text-[15px] font-bold text-white mb-1">{label}</p>
                  <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/55 leading-[1.7]">{desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-[#10B981]/5 border border-[#10B981]/15 rounded-[14px] p-6">
            ...
            <p className="font-mono text-[14px] text-white/80 leading-[1.8]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
              ...
              <p className="font-mono text-[14px] text-white/60 leading-[1.8] mb-4 italic">
            ...
            <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
              ...
              <p className="font-mono text-[14px] text-white/75 leading-[1.8] mb-4">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/40 mb-6">About 5 minutes · ChatGPT (free or paid)</p>
          ...
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 mb-4">
            <div className="space-y-5">
              ...
              <div className="bg-[#0F0F1A] border border-white/[0.08] rounded-[10px] p-4">
                ...
                <p className="font-mono text-[14px] text-[#10B981] leading-[2]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[15px] font-bold text-white mb-2">Teach the formula to someone else.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[16px] font-bold text-white">ChatGPT Memory &amp; Projects</p>
