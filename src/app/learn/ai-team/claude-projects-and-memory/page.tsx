    ...
    <>
      ...
      <main className="min-h-screen bg-[#0F0F1A]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-4 mb-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={label} className="flex gap-3 py-3 border-b border-white/[0.05] last:border-0">
                    ...
                    <div>
                      <p className="font-[family-name:var(--font-inter)] text-[14px] font-bold text-white/80">{label}</p>
            ...
            <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
              ...
              <p className="font-mono text-[13px] text-white/75 leading-[1.9]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/40 mb-6">About 10 minutes · Claude (claude.ai)</p>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[15px] font-bold text-white mb-2">Upload a file to your Project.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[16px] font-bold text-white">Claude Code</p>
