    ...
    <>
      ...
      <main className="min-h-screen bg-[#0F0F1A]">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={point} className="border-b border-white/[0.05] pb-4 last:border-0 last:pb-0">
                  <p className="font-[family-name:var(--font-inter)] text-[15px] font-bold text-white mb-1">{point}</p>
                  <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/55 leading-[1.6]" dangerouslySetInnerHTML={{ __html: detail }} />
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={step} className="flex items-start gap-3">
                  ...
                  <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/60 leading-[1.6]">{step}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
              ...
              <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-[1.8] mt-3">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/40 mb-6">About 5 minutes · gemini.google.com (free)</p>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[16px] font-bold text-white mb-2">Replace your next Google search with Gemini.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#22C55E]/8 border border-[#22C55E]/20 rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[17px] font-bold text-white">Take the Final Assessment</p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#22C55E] hover:opacity-90 transition-opacity text-[#0F0F1A] font-bold font-[family-name:var(--font-inter)] text-[15px] px-5 py-3 rounded-xl shrink-0"
            >
