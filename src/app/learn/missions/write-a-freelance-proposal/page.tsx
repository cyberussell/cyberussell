...
import { Target, Clock, BarChart2, Lock } from "lucide-react";
...
const steps = [
  { title: "Read the job post and extract key pain points", desc: "Identify exactly what the client needs — not what they said, but what they actually want solved." },
  { title: "Research the client with Gemini", desc: "Spend 5 minutes learning about their business so your proposal feels tailored, not templated." },
  { title: "Draft your proposal with Claude", desc: "Use Claude to write a proposal that leads with the client's problem, not your credentials." },
  { title: "Add a specific offer and clear next step", desc: "End with exactly what you'll deliver, your rate, and one clear call to action." },
  { title: "Review, personalize, and send", desc: "Read it as the client. Remove anything that sounds like everyone else's proposal." },
];
