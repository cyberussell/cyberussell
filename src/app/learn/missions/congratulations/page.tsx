      ...
      <main className="min-h-screen bg-[#0F0F1A] px-6 py-16">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-[#14141e] border border-white/[0.06] rounded-2xl p-6 mb-8">
            ...
            <p className="font-sans text-[17px] font-bold text-white mb-1">Mission Complete Bida Badge</p>
          ...
          <a href="/careers" className="font-[family-name:var(--font-inter)] text-[14px] text-white/35 hover:text-white/60 transition-colors">
