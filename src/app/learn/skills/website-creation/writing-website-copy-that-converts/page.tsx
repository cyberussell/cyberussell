    ...
    <>
      ...
      <main className="min-h-screen bg-[#0F0F1A]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[16px] text-white/50 leading-[1.8]">Most websites have design but no copy. That's why they don't convert.</p>
        </section>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="rounded-[14px] p-5" style={{ backgroundColor: `${COLOR}10`, border: `1px solid ${COLOR}30` }}>
            ...
            <p className="font-sans text-[16px] font-bold text-white leading-[1.5]">Write a homepage headline, about page, and services section using AI — in your voice, for your audience.</p>
          </div>
        </section>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={section.page} className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
                <p className="font-sans text-[16px] font-bold mb-4" style={{ color: section.color }}>{section.page}</p>
                <div className="space-y-3">
                  {section.sections.map((s) => (
                    <div key={s.label}>
                      <p className="font-[family-name:var(--font-inter)] text-[13px] font-bold text-white/70 mb-1">{s.label}</p>
                      <p className="font-[family-name:var(--font-inter)] text-[13px] text-white/45 leading-[1.6]">{s.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/40 mb-6">20 minutes · Claude (recommended for copy)</p>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#A78BFA]/5 border border-[#A78BFA]/15 rounded-[14px] p-6">
            ...
            <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/70 leading-[1.8]">Read your homepage headline out loud. <span className="text-white font-bold">Would a stranger know in 5 seconds what you do and if they need it?</span> If not, simplify.</p>
          </div>
        </section>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[15px] font-bold text-white mb-2">Show your copy to someone who doesn't know what you do.</p>
            <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/55 leading-[1.7]">Send your homepage headline and services section to a friend or family member who has no context. Ask: "What do you think I do? Who do you think I help?" Their answer reveals how clear (or unclear) your copy actually is.</p>
          </div>
        </section>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[16px] font-bold text-white">Building a Portfolio Site with Claude</p>
              <p className="font-[family-name:var(--font-inter)] text-[13px] text-white/45 mt-1">Website Creation · Lesson 5 of 7 · 15 min</p>
            </div>
            <a href="/learn/skills/website-creation/building-a-portfolio-site-with-claude" className="inline-flex items-center gap-2 text-white font-bold font-[family-name:var(--font-inter)] text-[14px] px-5 py-3 rounded-xl shrink-0 hover:opacity-90 transition-opacity" style={{ backgroundColor: COLOR }}>
