...
export const metadata: Metadata = {
  ...
  description:
    "Build real software with Claude and ChatGPT as your dev team. Learn to code with AI — or build without knowing how to code at all.",
  alternates: { canonical: "https://www.cyberussell.com/learn/skills/programming" },
  openGraph: {
    title: "Programming with AI | Cyberussell",
    description: "Build software with Claude and ChatGPT as your dev team.",
    url: "https://www.cyberussell.com/learn/skills/programming",
...
const lessons = [
  { title: "How AI Changes Programming (and Who It's For Now)", desc: "Why you don't need to memorize syntax — and what you DO need to understand.", soon: true },
  { title: "Your First App with Claude: Idea to Working Code", desc: "Build a real app from scratch by prompting Claude — step by step.", soon: true },
  { title: "Reading and Understanding AI-Generated Code", desc: "How to make sense of the code AI writes so you can debug it and own it.", soon: true },
  { title: "HTML, CSS, and JavaScript: The Web Fundamentals", desc: "The minimum you need to understand to build and modify websites with AI.", soon: true },
  { title: "Working with APIs: Connect Your App to the World", desc: "How to use external services and data in your app — with AI handling the hard parts.", soon: true },
  { title: "Debugging with AI: How to Fix Code When It Breaks", desc: "The prompting strategies that turn AI into your personal debugger.", soon: true },
  { title: "Deploying Your App: From Local to Live", desc: "How to get your app on the internet — and keep it running.", soon: true },
];
      ...
      <main className="min-h-screen bg-[#0F0F1A]">
        <section className="px-6 md:px-10 pt-16 pb-10 max-w-5xl mx-auto">
          ...
          <p className="font-[family-name:var(--font-inter)] text-[16px] text-white/55 leading-[1.8] mb-4 max-w-2xl">
            AI has lowered the floor for building software — but it hasn&rsquo;t removed the need to
            think clearly. This track teaches you how to build real apps by working with Claude and
            ChatGPT as your development team, while building enough understanding to direct them well.
          </p>
          <div className="inline-block bg-white/[0.05] border border-white/[0.08] rounded-lg px-4 py-2 mb-6">
            <p className="font-[family-name:var(--font-inter)] text-[13px] text-white/50">
              <span className="text-white/70 font-bold">Outcome:</span> You build and ship real software — with AI doing the heavy lifting.
            </p>
          </div>
