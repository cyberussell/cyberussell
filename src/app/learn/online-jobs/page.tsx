...
export const metadata: Metadata = {
  title: "Learn About Online Jobs — Guide for Filipinos | Cyberussell",
  description:
    "Free guides on finding legitimate online jobs as a Filipino — remote work, virtual assistant roles, customer service, and more.",
  alternates: { canonical: "https://www.cyberussell.com/learn/online-jobs" },
};

export default function LearnOnlineJobsPage() {
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-[#0F0F1A] px-6 md:px-10 py-16 max-w-4xl mx-auto">
        <nav className="flex items-center gap-2 text-[12px] font-[family-name:var(--font-inter)] text-white/35 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Online Jobs</span>
        </nav>
        ...
        <h1 className="font-sans text-[32px] md:text-[44px] font-bold text-white mb-4 leading-tight">
          Learn About Online Jobs
        </h1>
        <p className="font-[family-name:var(--font-inter)] text-[16px] text-white/60 leading-[1.8] mb-10 max-w-2xl">
          Guides on finding and landing legitimate online jobs as a Filipino — remote work,
          virtual assistant roles, data entry, customer service, and more.
        </p>
