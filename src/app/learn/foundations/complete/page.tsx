            ...
            {mode === "signin" && (
              <form onSubmit={handleEmailRegister} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl bg-[#FFD23F] text-[#0a0a12] font-[family-name:var(--font-inter)] text-[15px] font-bold hover:bg-[#FFD23F]/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
