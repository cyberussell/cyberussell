...
const BENEFITS = [
  { icon: Medal, color: "#FFD23F", text: "Earn your first Bida Badge" },
  ...
  { icon: Rocket, color: "#60A5FA", text: "Unlock Pillar 2" },
        ...
        <div className="w-full max-w-[520px]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="font-[family-name:var(--font-inter)] text-[16px] text-white/60 leading-relaxed">
              ...
              <span className="text-white font-semibold">Pillar 1: AI Foundations.</span>
            </p>
          </div>
          ...
          <div className="bg-[#14141e] border border-white/[0.08] rounded-2xl p-6 mb-6">
            <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/70 leading-relaxed mb-5 text-center">
              ...
              <br />
              <span className="text-white/90 font-medium">Take the final assessment to earn your first Bida Badge and personalized certificate.</span>
            </p>
            ...
            {mode === "signin" && (
              <form onSubmit={handleEmailRegister} className="space-y-3">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl bg-[#FFD23F] text-[#0a0a12] font-[family-name:var(--font-inter)] text-[14px] font-bold hover:bg-[#FFD23F]/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                >
