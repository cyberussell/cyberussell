      ...
      <main className="min-h-screen bg-[#0F0F1A]">
            ...
            {[
              ...
              <div key={item.num} className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-5 flex gap-4">
                <div className="w-8 h-8 rounded-full bg-[#A78BFA]/15 flex items-center justify-center shrink-0 mt-0.5">
                  <span className="font-sans text-[14px] font-bold text-[#A78BFA]">{item.num}</span>
                </div>
                <div>
                  <p className="font-sans text-[16px] font-bold text-white mb-2">{item.title}</p>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
              ...
              <p className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-[1.8] italic">
                "I need to make more money."
              </p>
              <p className="font-[family-name:var(--font-inter)] text-[14px] text-white/35 mt-2">
            ...
            <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6">
              ...
              <div className="font-[family-name:var(--font-inter)] text-[15px] text-white/60 leading-[1.8] space-y-2">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[16px] font-bold text-white mb-2">Do this with every problem that stops you this week.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[17px] font-bold text-white">The Problem Decomposition Method</p>
