    ...
    <>
      ...
      <main className="min-h-screen bg-[#0F0F1A]">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          ...
          <div className="font-[family-name:var(--font-inter)] text-[16px] text-white/60 leading-[1.9] mb-6">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={step.num} className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-5 flex gap-4">
                ...
                <div>
                  <p className="font-sans text-[16px] font-bold text-white mb-1">{step.title}</p>
          ...
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 mb-4">
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="font-[family-name:var(--font-inter)] text-[15px] text-white/65 mt-2 leading-[1.8] space-y-2">
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[16px] font-bold text-white mb-2">Have a deep conversation about something you have been avoiding.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[17px] font-bold text-white">Why Big Problems Feel Impossible</p>
