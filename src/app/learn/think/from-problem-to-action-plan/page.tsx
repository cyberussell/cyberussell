      ...
      <main className="min-h-screen bg-[#0F0F1A]">
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              <div key={item.label} className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-5">
                <p className="font-sans text-[16px] font-bold text-white mb-1">{item.label}</p>
        ...
        <section className="px-6 md:px-10 pb-10 max-w-3xl mx-auto">
          <div className="bg-[#F59E0B]/5 border border-[#F59E0B]/15 rounded-[14px] p-6">
            ...
            <p className="font-sans text-[16px] font-bold text-white mb-2">Actually do Step 1.</p>
        ...
        <section className="px-6 md:px-10 pb-20 max-w-3xl mx-auto">
          <div className="bg-[#18181F] border border-white/[0.08] rounded-[14px] p-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="font-sans text-[17px] font-bold text-white">Why Your First Idea Is Rarely Your Best</p>
