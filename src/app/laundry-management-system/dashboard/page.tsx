...
const QUICK_ACTIONS = [
  { label: 'New Walk-in Order', href: '/laundry-management-system/dashboard/orders/new', icon: PlusCircle },
  { label: 'Add Customer', href: '/laundry-management-system/dashboard/customers/new', icon: UserPlus },
  { label: 'Manage Inventory', href: '/laundry-management-system/dashboard/inventory', icon: Boxes },
  { label: 'Invite Staff', href: '/laundry-management-system/dashboard/staff', icon: Mail },
]
