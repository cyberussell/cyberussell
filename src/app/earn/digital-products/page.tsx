...
export const metadata: Metadata = {
  title: "Selling Digital Products as a Filipino | Cyberussell",
  description: "How to create and sell digital products online — ebooks, templates, courses, and prompt packs. Earn while you sleep.",
  alternates: { canonical: "https://www.cyberussell.com/earn/digital-products" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-[#0F0F1A] px-6 md:px-10 py-16 max-w-4xl mx-auto">
        <nav className="flex items-center gap-2 text-[12px] font-[family-name:var(--font-inter)] text-white/35 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Digital Products</span>
        </nav>
        ...
        <h1 className="font-sans text-[32px] md:text-[44px] font-bold text-white mb-4 leading-tight">Digital Products</h1>
        <p className="font-[family-name:var(--font-inter)] text-[16px] text-white/60 leading-[1.8] mb-10 max-w-2xl">
          Create once, sell forever. Digital products like ebooks, templates, courses, and prompt packs
