...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.cyberussell.com/earn/freelance-platforms" },
  openGraph: {
    title: "Where to Find Online Work as a Filipino | Cyberussell",
    description: "Honest reviews of the best platforms for Filipino freelancers — which ones work, how much they pay, and how to get started.",
    url: "https://www.cyberussell.com/earn/freelance-platforms",
...
export default function FreelancePlatformsPage() {
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Freelance Platforms", item: "https://www.cyberussell.com/earn/freelance-platforms" },
    ],
  };
    ...
    <main className="min-h-screen bg-[#0F0F1A] px-6 py-16 md:py-24">
      <div className="max-w-4xl mx-auto">
        <nav className="flex items-center gap-2 text-[12px] font-[family-name:var(--font-inter)] text-white/35 mb-8">
          ...
          <span>/</span>
          <span className="text-white/60">Freelance Platforms</span>
        </nav>
        <div className="mb-12">
          ...
          {PLATFORMS.map((p) => (
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 rounded-lg bg-white/[0.06] flex items-center justify-center shrink-0"><p.icon size={18} className="text-white/70" strokeWidth={1.8} /></div>
        ...
        <div className="text-center mt-8">
          <a href="/earn" className="font-[family-name:var(--font-inter)] text-[14px] text-white/55 hover:text-white transition-colors">
            ← Back to Ways to Earn
          </a>
        </div>
      </div>
    </main>
