...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      images: [{ url: slug === "how-to-earn-money-online-philippines-beginners" ? "/blog-og-skill-price-v2.jpg" : "/og-image.jpg", width: 1200, height: 630 }],
    },
    twitter: {
      card: "summary_large_image",
      title: post.title,
      description: post.description,
      images: [slug === "how-to-earn-money-online-philippines-beginners" ? "/blog-og-skill-price-v2.jpg" : "/og-image.jpg"],
    },
  };
}
