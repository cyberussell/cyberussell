...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      images: [{ url: slug === "how-to-earn-money-online-philippines-beginners" ? "/blog-og-skill-price-v2.jpg" : slug === "tiktok-creator-requirements-to-earn" ? "/blog_2_tiktok_will_pay_you.png" : slug === "ai-jobs-philippines-no-coding-2026" ? "/blog-og-ai-jobs-2026.png" : slug === "online-scams-philippines-2026" ? "/blog-og-scams-2026.png" : "/og-image.jpg", width: 1200, height: 630 }],
    },
    twitter: {
      card: "summary_large_image",
      title: post.title,
      description: post.description,
      images: [slug === "how-to-earn-money-online-philippines-beginners" ? "/blog-og-skill-price-v2.jpg" : slug === "tiktok-creator-requirements-to-earn" ? "/blog_2_tiktok_will_pay_you.png" : slug === "ai-jobs-philippines-no-coding-2026" ? "/blog-og-ai-jobs-2026.png" : slug === "online-scams-philippines-2026" ? "/blog-og-scams-2026.png" : "/og-image.jpg"],
    },
  };
}
...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const postImage = slug === "how-to-earn-money-online-philippines-beginners" ? "/blog-og-skill-price-v2.jpg" : slug === "tiktok-creator-requirements-to-earn" ? "/blog_2_tiktok_will_pay_you.png" : slug === "ai-jobs-philippines-no-coding-2026" ? "/blog-og-ai-jobs-2026.png" : slug === "online-scams-philippines-2026" ? "/blog-og-scams-2026.png" : "/og-image.jpg";
  const articleSchema = {
