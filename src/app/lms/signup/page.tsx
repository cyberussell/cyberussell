    ...
    <div className="flex min-h-screen flex-col bg-[#050816]">
      ...
      <main className="flex flex-1 items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          <Link href="/lms" className="mb-2 flex flex-col items-center text-center">
          ...
          {confirmEmail ? (
            <div className="rounded-xl border border-[#38BDF8]/30 bg-[#38BDF8]/10 p-6 text-center">
              ...
              <p className="text-white/60 text-sm mt-2">
                ...
                after confirming, <Link href="/lms/login" className="underline text-[#38BDF8]">log in here</Link>.
                Didn&apos;t get it? You can resend it from the{' '}
                <Link href="/lms/login" className="underline text-[#38BDF8]">login page</Link>.
              </p>
            </div>
          ) : (
