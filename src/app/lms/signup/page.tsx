          ...
          {confirmEmail ? (
            <div className="rounded-xl border border-[#22D3EE]/30 bg-[#22D3EE]/10 p-6 text-center">
              ...
              <p className="text-white/60 text-sm mt-2">
                ...
                after confirming, <Link href="/lms/login" className="underline text-[#22D3EE]">log in here</Link>.
                Didn&apos;t get it? You can resend it from the{' '}
                <Link href="/lms/login" className="underline text-[#22D3EE]">login page</Link>.
              </p>
            </div>
          ) : (
