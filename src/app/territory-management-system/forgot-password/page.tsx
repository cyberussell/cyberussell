...
import { requestPasswordResetAction } from '@/app/territory-management-system/actions/password'
        ...
        {sent ? (
          <div className="rounded-2xl border border-gray-300 bg-white p-6 text-center shadow-[0_1px_2px_rgba(15,23,42,0.04),0_0_18px_-3px_rgba(148,163,184,0.6)]">
            ...
            <p className="mt-2 text-sm text-slate-500">
              ...
              <Link href="/territory-management-system/login" className="text-[#2563EB] hover:underline">
                Back to login
              </Link>
              .
            </p>
