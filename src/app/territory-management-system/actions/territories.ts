...
export async function createTerritory(_prev: ActionResult, formData: FormData): Promise<ActionResult> {
  ...
  revalidatePath('/territory-management-system/dashboard/territories')
  redirect(`/territory-management-system/dashboard/territories/${territoryId}`)
}
...
export async function deleteTerritoryAction(territoryId: string): Promise<void> {
  ...
  revalidatePath('/territory-management-system/dashboard/territories')
  redirect('/territory-management-system/dashboard/territories')
}
