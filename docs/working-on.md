...
**Next recommended task:** Confirm the Vercel deploy succeeded and spot-check live once more: New Assignment summary box's new format, a Do Not Call record showing red on a partnership card, a Bible Study record showing the blue corner accent, and a fresh assignment's Ministry Partner correctly showing their assigned-records list (not search area).
