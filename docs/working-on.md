...
**Next recommended task:** Confirm both Vercel deploys succeeded and spot-check live: New Assignment summary box's new format, a Do Not Call record showing red, a Bible Study record showing the blue corner accent, territory/barangay showing on every partner card (not just multi-territory batches), and a fresh assignment's Ministry Partner correctly showing their assigned-records list.
