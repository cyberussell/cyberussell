...
create table public.assignment_batch_search_blocks (
...
create index assignment_batch_search_blocks_batch_idx on public.assignment_batch_search_blocks (batch_id);
create index assignment_batch_search_blocks_block_idx on public.assignment_batch_search_blocks (block_id);
...
-- keeps read-only access, same as every other assignment table (004).
